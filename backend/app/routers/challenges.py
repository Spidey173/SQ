...
async def list_chapters(
    ...
    # Return instantly if visitor and public chapters already compiled
    if not current_user and _PUBLIC_CHAPTERS_CACHE:
        return _PUBLIC_CHAPTERS_CACHE

    # Fetch challenges from memory cache (0.01ms) or DB once
